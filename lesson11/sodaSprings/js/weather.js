var apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5678757&appid=d362c4077b18b4682fc44e89fb3992b7&units=imperial";
fetch(apiURL)
...
/* forecast */
var apiURL = "https://api.openweathermap.org/data/2.5/forecast?id=5678757&appid=d362c4077b18b4682fc44e89fb3992b7&units=imperial"
fetch(apiURL)
  .then((response) => response.json())
  .then((jsObject) => {
 var i = 0;
